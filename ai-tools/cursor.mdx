---
title: "Cursor setup"
description: "Set up the Cursor editor with the Mintlify skill so its AI assistant can author, edit, and refactor MDX pages in this documentation repository."
icon: "arrow-pointer"
---
